    ...
    <tbody>
      <tr>
        ...
        <tr key={idx}>
          ...
          <td className="cell">
            {props.user ? <div><button onClick={() => {props.cart.push(beer); props.handleRenderCart()}} className="btn btn-success">Add to Cart</button><br /><br /><br /><button onClick={() => {props.remove(props.cart, beer); props.handleRenderCart()}} className="btn btn-danger">Remove from Cart</button></div>  : <Link to="/login" className="btn btn-danger">Login</Link>}
